...
public class Sorter {
    ...
    public static util.LinkedList<DragonToSend> arbolBinario(java.util.LinkedList<Dragon> listaDragones){
        ...
        return yoursToMine(nuevaLista);

    }

    public static util.LinkedList<DragonToSend> AVLTree (java.util.LinkedList<Dragon> listaDragones){
    ...
    public static util.LinkedList<DragonToSend> quickSort(LinkedList<Dragon> listaDragones){
     ...
     */
    public static util.LinkedList<DragonToSend> selectionSort(LinkedList<Dragon> listaDragones){
     ...
     * @return linkedList con dragones ordenados por edad mediante SelectionSort
     */
    public static util.LinkedList<DragonToSend> insertionSort(LinkedList<Dragon> listaDragones){
    ...
    public static util.LinkedList<DragonToSend> yoursToMine(java.util.LinkedList<Dragon> list){

        util.LinkedList<DragonToSend> newlist = new util.LinkedList<DragonToSend>();
        for(Dragon dragon:list){
            newlist.add(DragonFactory.getDragon(dragon));
        }
        return newlist;
